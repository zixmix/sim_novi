...
export default function Body()
{
    return(
        <div>
            ...
            <section className=" menu-locations-home">
                <div className="container">
                    <div className="col-md-12">
                        <div className="centered">
                            <a href="https://order2.silverwarepos.com/app/SymposiumCafe#!/stores"
                               className="btn
                    btn-primary" style={{width:'100%'}}>Pick-Up Menu Online Orders</a>
                        </div>
                    </div>
                    <div className="col-md-12">
                        <div className="centered">
                            <a className="btn btn-primary">Locations</a>
                            <a className="btn btn-primary">Delivery</a>
                        </div>
                    </div>
                </div>
            </section>
